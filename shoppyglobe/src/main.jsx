    ...
    children: [
      {
        ...
        lazy: async () => {
          const { default: ProductList } = await import('./pages/ProductList/ProductList.jsx');
      ...
      },
      {
        ...
        lazy: async () => {
          const { default: ProductDetail } = await import('./pages/ProductDetail/ProductDetail.jsx');
      ...
      },
      {
        path: "checkout",
        lazy: async () => {
          const { default: Checkout } = await import('./pages/Checkout/Checkout.jsx');
      ...
      // The 404 handler is defined separately below
      {
        path: "*",
        lazy: async () => {
          const { default: NotFound } = await import('./pages/NotFound/NotFound.jsx');
